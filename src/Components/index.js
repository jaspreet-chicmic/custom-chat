...
function ChatSideBar() {
	...
	useEffect(()=>{
		setUploadFile(document.getElementById("fileInput"))
	...
	return (	
		<>
		<input onChange={(e)=>setUploadFile(e.target.file)} id="fileInput" type="file"/>
			<MessageBox
				position={"left"}
				type={"file"}
				title={"Esra"}
				text="Sample PDF"
				data={{
					uri: "file:///home/chicmic/Downloads/You%20don't%20know%20Js%20(%20PDFDrive%20).pdf",
					status: {
						click: false,
						loading: 1,
					},
